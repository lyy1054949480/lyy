...
<pkg:package xmlns:pkg="http://schemas.microsoft.com/office/2006/xmlPackage">
    ...
    <pkg:part pkg:name="/word/_rels/document.xml.rels"
        ...
        <pkg:xmlData>
            <Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
                ...
                <Relationship Id="rId${image.name!""}" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/image"
                              Target="media/image${image.name!""}.png"/>
                </#list>
                ...
                <w:body>
                    ...
                    <w:p>
                        ...
                        <w:r>
                            ...
                            <w:pict>
                                <v:shape id="_x0000_i1031" o:spt="75" alt="banner" type="#_x0000_t75" style="width:61.15pt;height:36.8pt;"
                                         filled="f" o:preferrelative="t" stroked="f" coordsize="21600,21600">
                                    <v:path/>
                                    <v:fill on="f" focussize="0,0"/>
                                    <v:stroke on="f"/>
                                    <v:imagedata r:id="rId${image.name!""}" o:title="banner"/>
                    ...
                    <w:sectPr w:rsidR="00272ACC" w:rsidRPr="00046B4D">
    ...
    <#list images as image>
    <pkg:part pkg:name="/word/media/image${image.name}.png" pkg:contentType="image/png" pkg:compression="store">
        <pkg:binaryData>
            ${image.data}
        </pkg:binaryData>
    </pkg:part>
    ...
    <pkg:part pkg:name="/customXml/itemProps1.xml"
        ...
        <pkg:xmlData pkg:originalXmlStandalone="no">
            <ds:datastoreItem ds:itemID="{AC6B52DA-5E11-4C5C-8AA2-BFAFEB753DC3}"
    ...
    <pkg:part pkg:name="/docProps/core.xml" pkg:contentType="application/vnd.openxmlformats-package.core-properties+xml"
        ...
        <pkg:xmlData>
            <cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties"
                ...
                <dcterms:created xsi:type="dcterms:W3CDTF">2020-03-31T12:31:00Z</dcterms:created>
                <dcterms:modified xsi:type="dcterms:W3CDTF">2020-03-31T12:31:00Z</dcterms:modified>
            </cp:coreProperties>
        </pkg:xmlData>
    </pkg:part>
