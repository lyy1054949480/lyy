/*
package com.example.lyy.baidu.voice;
...
public class TtsMain {
    ...
    private final String appKey = "KEkrnQUvLdOwdRtm1ZHm5FWD";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    private final String secretKey = "ACBxZvapxksQhylfuTldIr6B7Hnr8K38";

    // text 的内容为"欢迎使用百度语音合成"的urlencode,utf-8 编码
    // 可以百度搜索"urlencode"
    private final String text = "傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！傻逼！";
    ...
    private void run() throws Exception {
        ...
        if (contentType.contains("mp3")) {
            ...
            File file = new File("D:\\result.mp3"); // 打开mp3文件即可播放
