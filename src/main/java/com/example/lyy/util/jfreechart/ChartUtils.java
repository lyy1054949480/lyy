...
public class ChartUtils {
	...
	public static void setStackBarRender(CategoryPlot plot) {
        ...
        renderer.setSeriesPaint(0,new Color(37, 119, 175));
        renderer.setSeriesPaint(1,new Color(188, 26, 22));
        renderer.setMaximumBarWidth(0.02);
        //renderer.setItemMargin(-0.4);
		//renderer.setItemMargin(1);//设置每个category所包含的平行柱的之间距离
		renderer.setBaseItemLabelGenerator(new StandardCategoryItemLabelGenerator());
	...
	public static void setXAixs(CategoryPlot plot) {
        ...
        plot.getDomainAxis().setTickLabelFont(new Font("宋体",Font.PLAIN,11));
	...
	public static void setPieRender(Plot plot) {
        ...
        piePlot.setSimpleLabels(true);//简单标签,不绘制线条
        piePlot.setLabelGenerator(null);//不显示数字
        // piePlot.setSimpleLabels(true);// 简单标签
		piePlot.setLabelGap(0.01);
		piePlot.setInteriorGap(0.05D);
		piePlot.setLabelFont(new Font("黑体", Font.TRUETYPE_FONT, 15));
		...
		piePlot.setLabelGenerator(new StandardPieSectionLabelGenerator("{2}"));// 显示标签数据
	}
