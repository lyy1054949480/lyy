package com.example.lyy.util.io.QRCode;
 ...
 * @author 周志伟
 * @projectname 项目名称:
 * @classname: CreateColourImageORCode
 * @description:
 * @date 2019/8/7：18:53
 */
public class CreateColourImageORCode {
    ...
    public static void main(String[] args) throws IOException, WriterException {
        BufferedImage bufferedImage = genBarcode("https://www.cnblogs.com/yy123/p/11317199.html", 400, 400, "D:\\123.jpg");
        ImageIO.write(bufferedImage, "png", new FileOutputStream(new File("D:\\111.png")));
    }
    // 图片宽度的一半
    ...
    public static void encode(String content, int width, int height, String srcImagePath, HttpServletResponse response) {
        ...
        try {
            //生成图片文件
            ImageIO.write(genBarcode(content, width, height, srcImagePath), "jpg",  response.getOutputStream());
