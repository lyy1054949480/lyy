...
public class IDCardRuleUtil {
     ...
     */
    public IDCardRuleUtil(String cardNumber, String serTime) {
    ...
    private static String contertToNewCardNumber(String oldCardNumber) {
        ...
        buf.append(IDCardRuleUtil.calculateVerifyCode(buf));
        return buf.toString();
    }
